              ...
              <Stack
                ...
                sx={{
                  ...
                  "::after": {
                    content: '""',
                    position: "absolute",
                    borderRight: lang === "ar" ? "unset" : "2px solid #9F9F9F",
                    borderBottom: lang === "ar" ? "unset" : "1px solid #9F9F9F",
                    borderLeft: lang === "ar" ? "1px solid #9F9F9F" : "unset",
                    borderTop: lang === "ar" ? "1px solid #9F9F9F" : "unset",
